      ...
      listBook.forEach((item) => {
        ...
        amount.addEventListener("input", () => {
          ...
          for (let i = 3; i < TableCartInfo.childNodes.length; i++) {
            console.log(
              parseInt(TableCartInfo.childNodes[i].childNodes[3].innerHTML)
            );
            Total += parseInt(
...
function getPriceInfo() {
  var Total = 0;
  console.log(TableCartInfo.childNodes);
  for (let i = 3; i < TableCartInfo.childNodes.length; i++) {
    console.log(parseInt(TableCartInfo.childNodes[i].childNodes[3].innerHTML));
